...
export default function TopBar({ brand = 'opendevUI', brandColorClass = '', userEmail = 'usuario@example.com', onBrandClick, onAvatarClick }) {
  return (
      ...
      <Toolbar>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexGrow: 1 }}>
          <Box
            ...
            sx={{ width: 24, height: 24, borderRadius: 0.5, bgcolor: 'primary.main', cursor: onBrandClick ? 'pointer' : 'default' }}
